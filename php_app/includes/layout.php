...
// Include the database connection file to access isDatabaseAvailable function
    ...
    <header class="bg-dashboard-panel border-b border-gray-700 flex justify-between items-center px-4 py-2">
        <div class="flex items-center">
            ...
            <div class="text-dashboard-header text-lg flex items-center">
                ...
                $isConnected = isDatabaseAvailable();
                $statusColor = $isConnected ? 'bg-green-500' : 'bg-red-500';
                $statusText = $isConnected ? 'Connected' : 'Disconnected';
                ?>
                <div class="ml-2 flex items-center">
                    <div class="<?= $statusColor ?> h-3 w-3 rounded-full mr-1"></div>
                    <span class="text-xs <?= $isConnected ? 'text-green-400' : 'text-red-400' ?>"><?= $statusText ?></span>
                </div>
            </div>
        </div>
        <div class="flex items-center">
