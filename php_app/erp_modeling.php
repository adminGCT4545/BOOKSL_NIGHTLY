...
<div class="p-4">
    <div class="mb-4 px-2 flex justify-between items-center">
        <h1 class="text-xl font-medium text-dashboard-header">Modeling</h1>
    ...
    <div class="grid grid-cols-1 gap-6">
        ...
        <div class="bg-dashboard-panel rounded shadow p-4">
            <h2 class="text-dashboard-header text-lg mb-4">Modeling Based on PostgreSQL Data</h2>
...
echo renderLayout('BookSL Train Modeling', 'erpModeling', $content);
?>
